...
use webtraders\notify\services\NotifyService as NotifyServiceService;
 ...
 * @since     1.0.0.
 *
 * @property  NotifyServiceService $notifyService
 */
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['siteActionTrigger1'] = 'notify/default';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['cpActionTrigger1'] = 'notify/default/do-something';
            }
        );
